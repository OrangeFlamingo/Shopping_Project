...
public class ApiController {
	...
	@RequestMapping(path="/api/test-rest", method=RequestMethod.POST)
  public ResponseEntity<ApiResultVO> testRest(HttpServletRequest req, @ModelAttribute("apiRequestVO") ApiRequestVO apiRequestVO) {
